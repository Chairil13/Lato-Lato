...
!(function (t, e) {
  ...
  (t.fn.typeIt = function (i) {
    ...
    (t.typeIt = function (i, s) {
      (this.d = { strings: [], speed: 100, deleteSpeed: e, lifeLike: !0, cursor: !0, cursorSpeed: 1e3, breakLines: !0, breakDelay: 750, deleteDelay: 750, startDelay: 250, startDelete: !1, loop: !1, loopDelay: 750, html: !0, autoStart: !0, callback: function () {} }),
        (this.queue = []),
        (this.queueIndex = 0),
        (this.hasStarted = !1),
        (this.inTag = !1),
    ...
    (t.typeIt.prototype = {
      ...
      _isVisible: function () {
        ...
        if (!r) return !1;
        var a = { top: Math.min(1, (n.bottom - i.top) / s), bottom: Math.min(1, (i.bottom - n.top) / s), left: Math.min(1, (n.right - i.left) / h), right: Math.min(1, (i.right - n.left) / h) };
...
$(".typeIt")
  ...
  .tiType("Hi,")
  .tiPause(600)
  .tiType(" my name is Chairil Ali.")
  .tiBreak()
  .tiPause(1000)
  .tiSettings({ speed: 300 })
  .tiType("I'm a")
  .tiSettings({ speed: 75 })
  .tiType(" Web and Mobile Developer")
  .tiPause(2000)
  .tiDelete(30)
  .tiType("i like to drawing")
  .tiPause(2000)
  .tiDelete(10)
  .tiType("random thing's...")
  .tiPause(3000)
  .tiType("and also sleep :)")
  .tiPause(2000)
  .tiDelete()
  .tiType("This is a Lato-Lato online animation,")
  .tiPause(600)
  .tiType(" click the ball bellow to start.")
  .tiPause(600)
  .tiType(" Hope you enjoy it ")
  .tiPause(600)
  .tiType(":)");
